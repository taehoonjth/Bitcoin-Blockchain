...
describe('Block Class 테스트', () => {
  ...
  describe('calculateHash', () => {
    it('반환된 해시값의 데이터형은 문자열이어야합니다.', () => {
      let block = new Block(1, "05/01/2018", { amount: 4 });
      block.hash.should.be.a.String();
    })
    it('index, previousHash, timestamp, data의 데이터를 sha256함수를 활용해 만든 해시를 반환해야 합니다. ', () => {
      let block = new Block(1, "05/01/2018", { amount: 4 });
      let hash = SHA256(1 + '' + "05/01/2018" + JSON.stringify({ amount: 4 })).toString();
